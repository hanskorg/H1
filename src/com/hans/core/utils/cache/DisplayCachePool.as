package com.hans.core.utils.cache
{
	...
	public class DisplayCachePool
	{
		 ...
		 * 
		 */
		public function cacheMovieClip(name:String,target:MovieClip,dynamicCache:Boolean = true):void
		{
			if(ifHad(name)) return;
		 ...
		 * 
		 */
		public function getMovieClip(name:String,disableMouse:Boolean = true):MovieClip
		{
			if(!ifHad(name))
			{
				return null;
